                ...
                buildApksResult.variantList.forEach { variant ->
                    variant.apkSetList.forEach { apkSet ->
                        apkSet.apkDescriptionList.forEach { apkDescription ->
                            ...
                            // remove them so their APK set fits under Console's size limit.
                            ...
                            //
                            // Console makes no use of APK types besides split APKs, so we can
                            ...
                            // https://FeloStore.app/docs/guide/appendix/requirements.html#androiddebuggable
                            if (apk.manifest.application.debuggable == true) {
                                return ParseApkSetResult.Error.DebuggableError
                            }

                            // Verify the apk is not test-only
                            // https://FeloStore.app/docs/guide/appendix/requirements.html#androidtestonly
